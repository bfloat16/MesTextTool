...
namespace mes {
	...
	const script_info script_info::infos[] = {
		{ "ffexa"   , 0x7B69, { 0x00, 0x28 }, { 0x29, 0x2E }, { 0x2F, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF }, 0x43 },
		{ "ffexs"   , 0x7B6B, { 0x00, 0x28 }, { 0x29, 0x2E }, { 0x2F, 0x4B }, { 0x4c, 0x4F }, { 0x50, 0xFF }, 0x43 },
		{ "ef"      , 0x466A, { 0x00, 0x28 }, { 0x2A, 0x2F }, { 0x30, 0x4A }, { 0x4B, 0x4E }, { 0x4F, 0xFF }, 0x46 },
		{ "dcos"    , 0x315D, { 0x00, 0x2B }, { 0xFF, 0xFF }, { 0x2C, 0x45 }, { 0x46, 0x49 }, { 0x4A, 0xFF }, 0x42 },
		{ "ktlep"   , 0x6E69, { 0x00, 0x28 }, { 0x29, 0x2E }, { 0x2F, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF }, 0x45 },
		{ "dcws"    , 0x656C, { 0x00, 0x2B }, { 0x2C, 0x31 }, { 0x32, 0x4C }, { 0x4D, 0x50 }, { 0x51, 0xFF }, 0x48 },
		{ "dcsv"    , 0x636C, { 0x00, 0x2B }, { 0x2C, 0x31 }, { 0x32, 0x4C }, { 0x4D, 0x50 }, { 0x51, 0xFF }, 0x46 },
		{ "dcpc"    , 0x3D63, { 0x00, 0x2C }, { 0xFF, 0xFF }, { 0x2D, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF }, 0x44 },
		{ "dcmems"  , 0x315D, { 0x00, 0x2B }, { 0xFF, 0xFF }, { 0x2C, 0x45 }, { 0x46, 0x49 }, { 0x4A, 0xFF }, 0x42 },
		{ "dcdx"    , 0x7769, { 0x00, 0x28 }, { 0x29, 0x2E }, { 0x2F, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF }, 0x45 },
		{ "dcas"    , 0x4E69, { 0x00, 0x28 }, { 0x29, 0x2E }, { 0x2F, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF }, 0x43 },
		{ "dcbs"    , 0x3163, { 0x00, 0x2B }, { 0xFF, 0xFF }, { 0x2C, 0x48 }, { 0x49, 0x4C }, { 0x4D, 0xFF }, NULL },
		{ "dc2fl"   , 0x9C69, { 0x00, 0x28 }, { 0x29, 0x2E }, { 0x2F, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF }, 0x45 },
		{ "dc2bs"   , 0x316C, { 0x00, 0x2B }, { 0x2C, 0x31 }, { 0x32, 0x4C }, { 0x4D, 0x50 }, { 0x51, 0xFF }, NULL },
		{ "dc2dm"   , 0x9D72, { 0x00, 0x29 }, { 0x2A, 0x31 }, { 0x32, 0x4C }, { 0x4D, 0x50 }, { 0x51, 0xFF }, 0x44 },
		{ "dc2fy"   , 0x3866, { 0x00, 0x2E }, { 0xFF, 0xFF }, { 0x2F, 0x4B }, { 0x4C, 0x4F }, { 0x50, 0xFF }, 0x48 },
		{ "dc2cckko", 0x026C, { 0x00, 0x2B }, { 0x2C, 0x31 }, { 0x32, 0x4C }, { 0x4D, 0x50 }, { 0x51, 0xFF }, NULL },
		{ "dc2ccotm", 0x016C, { 0x00, 0x2B }, { 0x2C, 0x31 }, { 0x32, 0x4C }, { 0x4D, 0x50 }, { 0x51, 0xFF }, NULL },
		{ "dc2sc"   , 0x3B69, { 0x00, 0x28 }, { 0x29, 0x2E }, { 0x2F, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF }, 0x45 },
		{ "dc2ty"   , 0x5F69, { 0x00, 0x28 }, { 0x29, 0x2E }, { 0x2F, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF }, NULL },
		{ "dc2pc"   , 0x5769, { 0x00, 0x28 }, { 0x29, 0x2E }, { 0x2F, 0x49 }, { 0x4A, 0x4D }, { 0x4E, 0xFF }, 0x45 },
		{ "dc3rx"   , 0x9772, { 0x00, 0x2B }, { 0x2C, 0x33 }, { 0x34, 0x4E }, { 0x4F, 0x52 }, { 0x53, 0xFF }, 0x45 },
		{ "dc3pp"   , 0x9872, { 0x00, 0x2A }, { 0x2B, 0x32 }, { 0x33, 0x4E }, { 0x4F, 0x51 }, { 0x52, 0xFF }, 0x45 },
		{ "dc3wy"   , 0xA09F, { 0x00, 0x38 }, { 0x39, 0x41 }, { 0x42, 0x5F }, { 0x60, 0x63 }, { 0x64, 0xFF }, 0x55 },
		{ "dc3dd"   , 0xA5A8, { 0x00, 0x38 }, { 0x39, 0x43 }, { 0x44, 0x62 }, { 0x63, 0x67 }, { 0x68, 0xFF }, 0x58 },
		{ "dc4"     , 0xAAB6, { 0x00, 0x3A }, { 0x3B, 0x47 }, { 0x48, 0x68 }, { 0x69, 0x6D }, { 0x6E, 0xFF }, 0x5D },
		{ "dc4ph"   , 0xABB6, { 0x00, 0x3A }, { 0x3B, 0x47 }, { 0x48, 0x68 }, { 0x69, 0x6D }, { 0x6E, 0xFF }, 0x5D },
		{ "ds"      , 0x9F9A, { 0x00, 0x38 }, { 0x39, 0x4A }, { 0x41, 0x5E }, { 0x5F, 0x62 }, { 0x63, 0xFF }, 0x54 },
		{ "dsif"    , 0xA1A1, { 0x00, 0x39 }, { 0x3A, 0x42 }, { 0x43, 0x60 }, { 0x61, 0x64 }, { 0x65, 0xFF }, 0x56 },
		{ "tmpl"    , 0xA6B4, { 0x00, 0x3B }, { 0x3A, 0x46 }, { 0x46, 0x67 }, { 0x68, 0x6E }, { 0x6D, 0xFF }, 0x5C },
	};
	...
	auto script_helper::fetch_scene_text(bool absolute_file_offset) const -> std::vector<script_helper::text> 
	{
		...
		for (const script_view::token& token : this->m_MesView.tokens()) 
		{
			if (info->encstr.its(token.value)) 
			{
				...
				for (char& ch : text) { ch += 0x20; } // 解密字符串
